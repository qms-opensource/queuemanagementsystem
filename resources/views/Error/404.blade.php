...
@section('content')
<div class="container">
<div class="bg-logo-login"><div class="col-md-2"><img class="ogo" src="{{ asset('assets/img/Banner_sm_update.png') }}"></div><div class="col-md-8"><h3 style="color:#fff;text-align: center;font-weight:bold;">QUEUE MANAGEMENT SYSTEM </br> Postgraduate Institute of Medical Education &amp; Research, Chandigarh</h3></div></div>
   <div class="row">
        <div class="col-md-12">
