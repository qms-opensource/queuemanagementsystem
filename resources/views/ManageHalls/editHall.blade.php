			...
			<div class="card-header" data-background-color="purple">
				<div class="row">
					<div class="col-md-8">
						...
						<p class="category">Edit Block</p>
					</div>
					<div class="col-md-4">
					</div>
				</div>
			</div>
			<form name="managehall" method="post" action="{{url('/manage-block/update')}}" class="formValidate" id="formValidate" novalidate="novalidate">
				{{csrf_field()}}
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="col-md-11">
							<div class="form-group label-floating">
								...
								<input type="text" maxlength="30" id="hall" name="name" value="{{ old('name', $hall->name) }}" class="form-control">
					...
					<div class="col-md-4">
						...
						<div class="col-md-11">
							<div class="form-group label-floating">
								...
								<input type="text" name="capacity" maxlength="5" value="{{ old('capacity', $hall->capacity) }}" class="form-control">
							...
							<div class="form-group label-floating">
								...
								<select name="department" value="{{ old('department') }}" class="department form-control">
									...
									@if($department->add_hall == 1)
										<option value="{{$department->id}}" @if($department->id == $hall->department_id) selected=selected @endif>{{$department->name}}</option>
									@endif
									@endforeach
								</select>
				...
				<button type="submit" id="edithall" class="btn btn-primary pull-right">Update</button>
