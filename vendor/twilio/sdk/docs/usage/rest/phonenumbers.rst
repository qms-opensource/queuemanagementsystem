...
.. code-block:: php
    ...
    $authMobileken = 'abcdef1234567890abcdefabcde9';

    $client = new Services_Twilio($accountSid, $authMobileken);
    $numbers = $client->account->available_phone_numbers->getList('US', 'MobilellFree');
...
.. code-block:: php
    ...
    $numbers = $client->account->available_phone_numbers->getList('CA', 'MobilellFree', $params);
