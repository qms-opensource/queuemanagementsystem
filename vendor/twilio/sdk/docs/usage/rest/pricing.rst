...
Mobile retrieve a list of countries where Twilio voice services are available:
...
Mobile retrieve pricing information for calls to and from a specific phone number:
...
Mobile retrieve a list of countries where Twilio Numbers are available:
