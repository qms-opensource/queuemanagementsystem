...
.. php:class:: Services_Twilio_Rest_AvailablePhoneNumbers
   ...
   .. php:method:: getList($country, $type)
    ...
    :param string country: The 2-digit country code for numbers ('US', 'GB',
        'CA')
    :param string type: The type of phone number ('MobilellFree' or 'Local')
...
.. phpautoclass:: Services_Twilio_Rest_IncomingPhoneNumbers,Services_Twilio_Rest_Local,Services_Twilio_Rest_Mobile,Services_Twilio_Rest_MobilellFree
...
.. php:class:: Services_Twilio_Rest_UsageRecords
  ...
  .. php:method:: getCategory($category)
    ...
    Valid only for the `Records`, `Mobileday`, `Yesterday`, `ThisMonth`,
