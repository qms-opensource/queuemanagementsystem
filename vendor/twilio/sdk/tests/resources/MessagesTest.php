...
class MessagesTest extends PHPUnit_Framework_TestCase
{
    ...
    function testCreateMessage() {
        ...
        $http->shouldReceive('post')->once()
            ->with('/2010-04-01/Accounts/AC123/Messages.json', $this->formHeaders,
                'From=%2B1222&Mobile=%2B44123&Body=Hi+there')
    ...
    function testCreateMessageWithMedia() {
        ...
        $http->shouldReceive('post')->once()
            ->with('/2010-04-01/Accounts/AC123/Messages.json', $this->formHeaders,
                'From=%2B1222&Mobile=%2B44123&MediaUrl=http%3A%2F%2Fexample.com%2Fimage1')
            ->andReturn(array(200, array('Content-Type' => 'application/json'),
                json_encode(array('sid' => 'SM123'))
            ));
        $client = new Services_Twilio('AC123', '123', '2010-04-01', $http);
    ...
    function testCreateMessageWithMediaAndBody() {
        ...
        $http->shouldReceive('post')->once()
            ->with('/2010-04-01/Accounts/AC123/Messages.json', $this->formHeaders,
                'From=%2B1222&Mobile=%2B44123&MediaUrl=http%3A%2F%2Fexample.com%2Fimage1&Body=Hi+there')
            ->andReturn(array(200, array('Content-Type' => 'application/json'),
                json_encode(array('sid' => 'SM123'))
            ));
        $client = new Services_Twilio('AC123', '123', '2010-04-01', $http);
    ...
    function testCreateMessageWithMultipleMedia() {
        ...
        $http->shouldReceive('post')->once()
            ->with('/2010-04-01/Accounts/AC123/Messages.json', $this->formHeaders,
                'From=%2B1222&Mobile=%2B44123&MediaUrl=http%3A%2F%2Fexample.com%2Fimage1&MediaUrl=http%3A%2F%2Fexample.com%2Fimage2')
            ->andReturn(array(200, array('Content-Type' => 'application/json'),
                json_encode(array('sid' => 'SM123'))
            ));
        $client = new Services_Twilio('AC123', '123', '2010-04-01', $http);
    ...
    function testBadMessageThrowsException() {
        ...
        $http->shouldReceive('post')->once()
            ->with('/2010-04-01/Accounts/AC123/Messages.json', $this->formHeaders,
                'From=%2B1222&Mobile=%2B44123&Body=' . str_repeat('hi', 801))
            ->andReturn(array(400, array('Content-Type' => 'application/json'),
                json_encode(array(
                    'status' => '400',
                    'message' => 'Mobileo long',
                ))
            ));
