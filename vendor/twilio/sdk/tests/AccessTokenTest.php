...
require_once 'Twilio/AccessMobileken.php';

class AccessMobilekenTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $scat = new Services_Twilio_AccessMobileken(self::ACCOUNT_SID, self::SIGNING_KEY_SID, 'secret');
        $token = $scat->toJWT();
