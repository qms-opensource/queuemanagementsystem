...
class TwilioTest extends PHPUnit_Framework_TestCase {
    ...
    protected $callParams = array('Mobile' => '123', 'From' => '123', 'Url' => 'http://example.com');
    ...
    function testRetryIdempotentFunctionsOnly() {
        ...
        $http->shouldReceive('post')->once()
            ->with('/2010-04-01/Accounts/AC123/SMS/Messages.json', $this->formHeaders,
                'From=%2B14105551234&Mobile=%2B14102221234&Body=bar')
            ->andReturn($this->nginxError);
        $client = new Services_Twilio('AC123', '123', '2010-04-01', $http);
    ...
    function testUnicode() {
        ...
        $http->shouldReceive('post')->once()
            ->with('/2010-04-01/Accounts/AC123/SMS/Messages.json', $this->formHeaders,
            'From=123&Mobile=123&Body=Hello+%E2%98%BA')
            ->andReturn(array(200, array('Content-Type' => 'application/json'),
    ...
    function testPostMultivaluedForm() {
        ...
        $http->shouldReceive('post')->once()
            ...
            'From=123&Mobile=123&MediaUrl=http%3A%2F%2Fexample.com%2Fimage1&MediaUrl=http%3A%2F%2Fexample.com%2Fimage2')
            ->andReturn(array(200, array('Content-Type' => 'application/json'),
                json_encode(array('sid' => 'SM123'))
            )
        );
