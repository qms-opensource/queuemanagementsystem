...
/**
 * Twilio Capability Mobileken generator
 *
 * @category Services
...
class Services_Twilio_Capability
{
     ...
     * @param $authMobileken the secret key used to sign the token. Note, this auth
     *        token is not visible to the user of the token.
     */
    public function __construct($accountSid, $authMobileken)
    {
        $this->accountSid = $accountSid;
        $this->authMobileken = $authMobileken;
        $this->scopes = array();
     ...
     */
    public function generateMobileken($ttl = 3600)
    {
        $payload = array(
            'scope' => array(),
            'iss' => $this->accountSid,
        ...
        return JWT::encode($payload, $this->authMobileken, 'HS256');
    }
