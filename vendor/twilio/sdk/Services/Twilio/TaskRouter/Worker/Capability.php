...
class Services_Twilio_TaskRouter_Worker_Capability extends Services_Twilio_TaskRouter_Capability
{
	...
	public function __construct($accountSid, $authMobileken, $workspaceSid, $workerSid, $overrideBaseUrl = null, $overrideBaseWSUrl = null)
	{
		parent::__construct($accountSid, $authMobileken, $workspaceSid, $workerSid, null, $overrideBaseUrl, $overrideBaseWSUrl);
