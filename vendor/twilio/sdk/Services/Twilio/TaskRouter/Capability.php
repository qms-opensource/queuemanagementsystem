...
class Services_Twilio_TaskRouter_Capability extends Services_Twilio_TaskRouter_CapabilityAPI
{
	...
	public function __construct($accountSid, $authMobileken, $workspaceSid, $channelId, $resourceUrl = null, $overrideBaseUrl = null, $overrideBaseWSUrl = null) {
		parent::__construct($accountSid, $authMobileken, $this->version, $channelId);
	...
	public function generateMobileken($ttl = 3600, $extraAttributes = null) {
		...
		return parent::generateMobileken($ttl, $taskRouterAttributes);
	}
}