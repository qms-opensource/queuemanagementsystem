        ...
        'form' => [
            'rules' => [
               ...
               /* 'mail_driver'           => 'required|string|max:50',
				...
				'app_display_name'     => 'required|string|max:50',
               // 'app_display_system'   => 'required|string|max:50',
				//'app_logo'=>'mimetypes:application/msword,application/pdf,image/png,image/jpeg,image/jpg,image/gif'
            ],
        ],
    ],
